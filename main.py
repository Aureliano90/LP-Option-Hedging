...
if __name__ == '__main__':
    ...
    spot = 530.
    # print(vanilla_option1(spot, 58000, dte/365, r, q, sigma, 1))
    # print(vanilla_option1(spot, 58000, dte/365, r, q, sigma, 2))
    cs = 700.
    ps = 700.
    # print("Call Strike {}, Put Strike {}".format(cs, ps))
    # print("Call price {}".format(vanilla_option1(spot,  cs, dte /365, r, q, sigma, 1)))
    # print("Put price {}".format(vanilla_option1(spot,  ps, dte/365, r, q, sigma, 2)))
